...
public class CommentsRepositoryTests
{
    ...
    private readonly CommentEntity pendingComment1 = new()
    {
    ...
    private readonly CommentEntity pendingComment2 = new()
    {
        Status = CommentStatus.Pending,
    ...
    public async Task Setup()
    {
        ...
        if (_context != null) _commentsRepository = new CommentsRepository(_context);
    ...
    {
        Assert.ThrowsAsync<KeyNotFoundException>(async delegate { await _commentsRepository.ApproveComment(new Guid()); });
    }
    ...
    {
        Assert.ThrowsAsync<KeyNotFoundException>(async delegate { await _commentsRepository.RejectComment(new Guid()); });
    }
    ...
    public void AddComment_Fails_UserHasNotReadTheBook()
    {
        ...
        Assert.ThrowsAsync<AppException>(async delegate { await _commentsRepository.AddComment(commentToAdd); });
    }
