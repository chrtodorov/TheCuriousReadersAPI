...
namespace DataAccessTests
{
    public class BookRequestsRepositoryTests
    {
        ...
        public async Task Setup()
        {
            ...
            if (_context != null)
            {
                _bookRequestsRepository = new BookRequestsRepository(_context, _logger);
            }
        ...
        {
            Assert.ThrowsAsync<ArgumentException>(async delegate { await _bookRequestsRepository.GetUserRequests(new Guid(), pagingParameters); });
        }
        ...
        public async Task MakeRequest_Fails_BookDoesNotExist()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(async delegate { await _bookRequestsRepository.MakeRequest(bookRequestModel); });
        }
