...
namespace DataAccessTests
{
    public class BookLoansRepositoryTests
    {
        ...
        private static BookItemEntity bookItem1 = new BookItemEntity
        {
        ...
        private static BookItemEntity invalidBookItem = new BookItemEntity
        {
        ...
        public async Task Setup()
        {
            ...
            if (_context != null)
            {
                _bookLoansRepository = new BookLoansRepository(_context);
            }
        ...
        {
            var userId = new Guid();
            Assert.ThrowsAsync<ArgumentException>(async delegate { await _bookLoansRepository.GetLoansById(userId, pagingParameters); });
        }

        [Test]
        public async Task LoanBook()
        {
            BookRequestEntity bookRequestEntity1 = new BookRequestEntity
            {
        ...
        public void LoanBook_Fails_CustomerDoesNotExist()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(async delegate { await _bookLoansRepository.LoanBook(bookLoan); });
        }
