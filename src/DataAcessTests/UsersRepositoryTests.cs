...
{
    private readonly User invalidUser = new()
    {
        FirstName = "Invalid",
        LastName = "User",
    ...
    private readonly User validAdmin = new()
    {
        FirstName = "Valid",
        LastName = "Admin",
    ...
    private readonly User validCustomer = new()
    {
        FirstName = "Valid",
        LastName = "Customer",
    ...
    private readonly User validLibrarian = new()
    {
        FirstName = "Valid",
        LastName = "Librarian",
    ...
    public async Task Setup()
    {
        ...
        if (_context != null) _usersRepository = new UsersRepository(_context, _logger);
    ...
    {
        Assert.ThrowsAsync<KeyNotFoundException>(async delegate { await _usersRepository.Register(invalidUser); });
    }
    ...
    public async Task GetUserByEmail_Fails()
    {
        ...
        Assert.ThrowsAsync<KeyNotFoundException>(async delegate { await _usersRepository.GetUser("wrong email"); });
    }
